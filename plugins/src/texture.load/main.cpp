...
// PNG CUBEMAP LOADER --------------------------------------------------------------------------------------
class module_load_png_cubemap : public vsx_module {
  // in
  float time;
  vsx_module_param_resource* filename_in;
  vsx_module_param_int* reload;
  ...
  static void* png_worker_v(void *ptr)
  {
    ...
    module_load_png_cubemap* module = ((module_load_png_cubemap*)ptr);
...
vsx_module* create_new_module(unsigned long module, void* args)
{
  ...
  switch(module) {
    ...
    case 7:
    return (vsx_module*)(new module_load_png_cubemap);
  };
  return 0;
}
...
void destroy_module(vsx_module* m,unsigned long module) {
  switch(module) {
    ...
    case 7: delete (module_load_png_cubemap*)m; break;
  }
}
